...
$content = <<<EOD
            ...
            <tr>
                <td width="45%">
                    ...
                    <div>
                        ...
                        <input type="checkbox" id="halway" name="halway" value="halway">
                        <label for="halway">   Hallways  </label> <br>
        ...
        <div style="font-size:14px">
           ...
           <div>A lot has changed in the way that cleaning is done today. The work can be much faster than in the past. $brandName  leads the industry in finding and using the best tools, techniques and training to give you a cleaning schedule that delivers more value within your budget. </div>
            ...
            <label for="restroom">  Restroom that look, smell, and actually clean. </label>
            ...
            <label for="restroom"> consistent cleaning and good communication with the cleaners </label>
            ...
            <table width="100%">
                <tr>
                    <td width="49%">
                        ...
                        <label for="waitingarea"> Waitingarea </label> <br>
            
                        <input type="checkbox" id="lobbyarea" name="lobbyarea" value="lobbyarea">
                        <label for="lobbyarea"> Lobbyarea </label> <br>
                    ...
                    <td width="49%">
                        <input type="checkbox" id="kitchenete" name="kitchenete" value="kitchenete">
                        <label for="kitchenete"> Kitchenette/Coffee Area </label> <br>
                        ...
                        <input type="checkbox" id="stairsways" name="stairsways" value="stairsways">
                        <label for="stairsways">  Stairways </label> <br>
                        ...
                        <label for="showroom"> Showroom Relail Areas </label> <br>
        ...
        <div>
            <h2> Other area are not listed above </h2>
            <table width="100%">
                <tr>
                    <td width="45%">
                        <h2> </h2> <br>
        ...
        <div style="font-size:13px;">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="68%"> <p> </p> <h3> DUSTING AND DESINFICATION </h3>  </td> 
                </tr>
            </table>
            ...
            <table width="100%" border="1" cellpadding="2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="20%"> N/A times per week </td>
                    </tr>
                </tbody>
            </table>
             <p> </p>
