...
if (!empty($additionalAddresses)) {
    $exhibit_clause = "<p>$contract_provider also agrees to clean the properties listed by address in Exhibit A at the end of this contract. They shall be cleaned according to the same schedule and to the same extent as outlined in the contract.</p>";
} else {
    $exhibit_clause = "";
}
...
<div class="container border rounded">
    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            ...
            <ul class="ps-3">
                ...
                <li>City State Zip: <span id="customer"><?php echo $cityStateZip ?> </span></li>
            </ul>
            ...
            <ol class="ps-3">
                <li>Monthly Services Charge: 
                    <p class="ms-4"> $ <?php echo $monthlyCharges ?> per month, plus taxes, if applicable; to include 3 time(s) per week services.</p>
                    <div class="mb-3">
                ...
                <li class="my-3">
                    CUSTOMER acknowledges that <?php echo($contract_provider) ?> will delegate all <?php echo($contract_provider) ?> System Services to be performed hereunder to a <?php echo $contract_provider ?> franchisee and/or subcontractor and <?php echo($contract_provider) ?> may assign this Service Agreement in its entirety to a <?php echo($contract_provider) ?> franchisee and/or subcontractor.
                </li>

                <li class="my-3">
                    Included in the Service Charge will be service, cleaning supplies, 
                    and any equipment which will be furnished by the <?php echo($contract_provider) ?> franchisee.
                    The Service Charge does not include liners, paper supplies, and toiletries, which can be provided at CUSTOMER's expense, at competitive prices. The Service Charge also does not include any use tax, tax on sales, services or supplies, or other such tax, which taxes shall be paid by CUSTOMER. CUSTOMER agrees to reimburse <?php echo($contract_provider) ?> the amount of any such taxes if paid by <?php echo($contract_provider) ?> on CUSTOMER's behalf.
                </li>

                <li class="my-3">
                    All <?php echo $contract_provider ?> System Services specified in the "<?php echo($contract_provider) ?> Service Plan" attached to this Service Agreement as Exhibit A will be provided to CUSTOMER in a satisfactory manner. CUSTOMER acknowledges that only those Services and/or Additional Services specifically identified in the <?php echo($contract_provider) ?> Service Plan will be provided under this Service Agreement.
                </li>
                <li class="my-3">
                    All <?php echo $contract_provider ?> franchises have successfully completed <?php echo($contract_provider) ?>'s comprehensive training program and are required to carry insurance and a janitorial bond.
                </li>
                <li class="my-3">
                    Additional services, not included in <?php echo($contract_provider) ?>'s Service Charge, to be performed upon request, priced per occurrence, at CUSTOMER'S expense, include:
                </li>
                ...
                <li class="my-3">
                   This Service Agreement and attached exhibits constitute the complete agreement of the parties concerning the provision of
                    ...
                    or other form subsequently submitted by CUSTOMER to <?php echo $contract_provider ?> become a part of this Service Agreement, and
    ...
    <div class="row px-4">
        <div class="col-lg-6">
            ...
            <hr class="mb-0 mt-4">
            <p class="mb-4">Print Name and Title, its Authorized Representative </p>
            <hr class="mb-0 mt-4">
        ...
        <div class="col-lg-6">
            ...
            <hr class="mb-0 mt-4">
            <p class="mb-4">Sales Consultant (Signature and Date)</p>
            <hr class="mb-0 mt-4">
            <p class="mb-4">Print Name and Title, its Authorized Representative </p>
            <hr class="mb-0 mt-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="heading fw-bold"> <?php echo $contract_provider ?> Safety and Security Document </h4>
            <p class="mt-2">
            ...
            <p>
                <span class="d-inline-block" style="width:16%">  Customer Address: </span> <span class="border-bottom border-black d-inline-block float-left" style="width: 78%;"> <?php echo $address . " " . $cityStateZip ?> </span>
            </p>
        </div>
    </div>
        <div class="row mt-4">
                ...
                <ol class="ps-3">
                    ...
                    <li class="mt-5">
                        ...
                        <div class="form-check ms-3">
                            ...
                            I am aware of Asbestos in the facility where the <?php echo $contract_provider ?> Franchised Business will be providing services, and if applicable, I will provide the Asbestos Control Plan to the representative of the <?php echo $contract_provider ?> Business.
                             </label>
                        </div>
                        <div class="form-check ms-3">
                            <input class="form-check-input" type="checkbox" value="" id="Tuesday" checked>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-12 text-center mt-5">
                ...
                <p class="mb-0" style="font-size: 56px; font-weight: bold; margin-top: 44px;"> Office of </p>
                <p class="mt-0" style="font-size: 56px; font-weight: bold;"> <?php echo $customerName; ?> </p>
   ...
   <hr>
    <div class="row my-4">
        ...
        <div class="col-lg-12 px-4">
            ...
            <p>
               Your <?php echo $contract_provider ?> Service Plan and Service Agreement are attached. Please review them to learn exactly how the <?php echo $contract_provider ?> Program will meet and exceed your expectations.
            </p>
            <p>
    ...
    <div class="row my-4">
        <div class="col-lg-5 px-0 mt-4">
            ...
            <div class="form-check ms-3">
                <input class="form-check-input" type="checkbox" value="" id="hallway">
                <label class="form-check-label" for="hallway">  Hallways </label>
            </div>
            <div class="form-check ms-3">
        ...
        <div class="col-lg-12">
            ...
            <div class="form-check ms-3">
                <input class="form-check-input" type="checkbox" value="" id="office">
                <label class="form-check-label" for="office">
                    Restrooms that look, smell, and are actually clean.
                </label>
            </div>
            <p>
            ...
            <div class="form-check ms-3">
                <input class="form-check-input" type="checkbox" value="" id="office">
                <label class="form-check-label" for="office">
                    A healthier workplace with cross-contamination prevention
                </label>
            </div>
            <p>
    ...
    <div class="row my-4">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-check ms-3">
                    <input class="form-check-input" type="checkbox" value="" id="stairways">
                    <label class="form-check-label" for="stairways">
                        Stairways
                    </label>
                </div>
            ...
            <div class="col-lg-12 my-4 mb-2">
                <h2 class="d-inline-block mt-2"> Other areas not listed above </h2>
            </div>
            <div class="row">
            ...
            <table class="table table-bordered rounded mt-4 text-start">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width:155px">  1 time per week </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td> Vacuum Furnishings or Wet Wipe </td>
                        <td> Vacuum fabric-covered furnishings and/or wet wipe other furniture to remove visible dust or soil </td>
                        <td> 1 time per month </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered rounded mt-4 text-start">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> Detail vacuum accessible carpeted areas with approved HEPA backpack units.</td>
                        <td> 1 time per month </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="row my-4">
        ...
        <div class="col-lg-12 text-center">
            ...
            <table class="table table-bordered rounded mt-4 text-start">
                ...
                <tbody>
                    <tr>
                        <td style="width:211px; padding-top: 111px;"> Clean and Disinfect Restrooms </td>
                        <td> 
                          <ul>
            ...
            <table class="table table-bordered rounded mt-4 text-start">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width:150px;"> 1 time per week </td>
                    </tr>
                    <tr>
...
{
    echo "<h3>Exhibit A - Additional Addresses</h3>";
    // Split the addresses by line (assuming they are separated by newlines)
    $addressesArray = explode("\n", $additionalAddresses);
    
    // Display each address
    echo "<ul>";
    foreach ($addressesArray as $address) {
        echo "<li>" . htmlspecialchars(trim($address)) . "</li>";
    }
    echo "</ul>";
}
